...
Runeword.create(name: 'Steel', item_type: 'Weapon', runeAmount: 2, stats: '20% Enhanced Damage', word: 'Tir El', image_url: 'https://www.almarsguides.com/AlmarsImages/Computer/Games/Diablo2/Misc/RuneWords/Weapon/Steel%20RuneWord%20in%20Tomahawk.png')
Runeword.create(name: 'Nadir', item_type: 'Helmet', runeAmount: 2, stats: '+50% Enhanced Defense', word: 'Nef Tir', image_url: 'https://diablo2.diablowiki.net/images/d/d0/Nadir.png')
Runeword.create(name: 'Ancients Pledge', item_type: 'Shield', runeAmount: 3, stats: '+50% Enhanced Defense', word: 'Ral Ort Tal', image_url: 'https://diablo2.diablowiki.net/images/6/6d/Ancients-inherent.jpg')
